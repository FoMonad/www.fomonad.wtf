...
`)[0]||String(e),a=typeof t?.message==`string`&&t.message||String(e),o=n||typeof t?.name==`string`&&t.name!==`Error`&&t.name||`ERROR`;window.dispatchEvent(new CustomEvent(`app-error-show`,{detail:{short:i,full:a,name:o}}))}var Pp=class extends up{constructor(...e){super(...e),this.open=!1,this.hash=null,this.action=``,this.transfers=null,this.errorMsg=``,this.errorFull=``,this.errorName=``,this._onError=e=>{this.errorMsg=e.detail.short,this.errorFull=e.detail.full,this.errorName=e.detail.name,this.hash=null,this.open=!0},this._onShow=e=>{this.hash=e.detail.hash,this.action=e.detail.action,this.transfers=null,this.open=!0,this._fetchTransfers(e.detail.hash)}}connectedCallback(){super.connectedCallback(),window.addEventListener(`tx-confirm-show`,this._onShow),window.addEventListener(`app-error-show`,this._onError)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`tx-confirm-show`,this._onShow),window.removeEventListener(`app-error-show`,this._onError)}async _fetchTransfers(e){let{connectedWallet:t}=await Yt(async()=>{let{connectedWallet:e}=await Promise.resolve().then(()=>Ku);return{connectedWallet:e}},void 0,import.meta.url);if(!t){this.transfers=[];return}let n=j,r=od(Zn),i=t.address.slice(2).toLowerCase(),a;for(let t=0;t<20;t++){try{if(a=await r.getTransactionReceipt({hash:e}),a)break}catch{}await new Promise(e=>setTimeout(e,800))}if(!a){this.transfers=[];return}let o=a.logs.filter(e=>e.topics[0]?.toLowerCase()===jp&&e.topics[2]?.slice(-40).toLowerCase()===i);if(o.length===0){this.transfers=[];return}let s=[];for(let e of o){let t=e.address,i=`0x`+(e.topics[1]??`0x`).slice(-40),a=BigInt(e.data),o;if(t.toLowerCase()===n.fomon.toLowerCase())o=`foMON`;else if(t.toLowerCase()===n.shmon.toLowerCase())o=`shMON`;else{let e=Y(`token:${t.toLowerCase()}:symbol`);if(e)o=e;else try{o=await r.readContract({address:t,abi:V,functionName:`symbol`})}catch{o=t.slice(0,6)+`...`}}let c=i.toLowerCase()===Mp&&t.toLowerCase()===n.fomon.toLowerCase();s.push({symbol:o,amount:a,isAirdrop:c})}this.transfers=s}_close(){this.open=!1}_breakPascal(e){return e.replace(/([a-z])([A-Z])/g,`$1​$2`)}async _copy(){this.hash&&await navigator.clipboard.writeText(this.hash)}static{this.styles=of`
  ...
  `}render(){if(!this.open)return H``;if(!this.hash)return H`
    ...
    `}};q([K()],Pp.prototype,`open`,void 0),q([K()],Pp.prototype,`hash`,void 0),q([K()],Pp.prototype,`action`,void 0),q([K()],Pp.prototype,`transfers`,void 0),q([K()],Pp.prototype,`errorMsg`,void 0),q([K()],Pp.prototype,`errorFull`,void 0),q([K()],Pp.prototype,`errorName`,void 0),Pp=q([W(`tx-confirm-dialog`)],Pp);var Fp=null,Ip=!1;async function Lp(){if(!Fp||Ip)return;Ip=!0;let e=await nr(()=>R(e=>e.readContract({address:j.game,abi:B,functionName:`cycle`})),!1,`vibecoin_db_cycle`),t=!1,n=e;for(;n>0n;){let r=await Fp.getFromIndex(`vibecoins`,`by-cycle`,Number(n));if(r!=null){if(!t){let i=await nr(()=>R(e=>e.readContract({address:j.game,abi:B,functionName:`vibecoinCycle`,args:[r.address]})),!1,`vibecoin_db_sanity_check`);if(i!=n){console.warn(`Search database is invalid. Vibecoin `+r.address+` was expected to made by cycle `+n+`, but it was actually in cycle `+i),n=e,await Fp.clear(`vibecoins`);continue}t=!0}n--;continue}let i=await nr(()=>R(e=>e.readContract({address:j.game,abi:B,functionName:`vibecoinByCycle`,args:[n]})),!1,`vibecoin_db_cycle_`+n);if(!i||i==`0x0000000000000000000000000000000000000000`){n--;continue}let[a,o]=await Promise.all([nr(()=>R(e=>e.readContract({address:i,abi:V,functionName:`name`})),!0,`vibecoin_db_cycle_`+n),nr(()=>R(e=>e.readContract({address:i,abi:V,functionName:`symbol`})),!0,`vibecoin_db_cycle_`+n)]);await Fp.put(`vibecoins`,{address:i.toLowerCase(),cycle:Number(n),name:a.toLowerCase(),symbol:o.toLowerCase()}),n--}Ip=!1}window.addEventListener(`lls-updated`,({detail:e})=>{for(let[t,n]of e)t==`game.phase`&&n==2&&Lp().catch(e=>{Np(e)})}),(async()=>{Fp=await Vd(`rugpad:`+Zn,1,{upgrade(e){let t=e.createObjectStore(`vibecoins`,{keyPath:`address`});t.createIndex(`by-cycle`,`cycle`),t.createIndex(`by-symbol`,`symbol`),t.createIndex(`by-name`,`name`)}}),await Lp()})().catch(e=>{Np(e)});function Rp(e){if(!e)return IDBKeyRange.lowerBound(``);let t=e.length-1,n=e.substring(0,t)+String.fromCharCode(e.charCodeAt(t)+1);return IDBKeyRange.bound(e,n,!1,!0)}async function zp(e){let t=Rp(e);if(!Fp)return null;if(e.startsWith(`0x`))return(await Fp.getAll(`vibecoins`,t,10)).map(e=>e.cycle);let n=(await Fp.getAllFromIndex(`vibecoins`,`by-symbol`,t,10)).map(e=>e.cycle);n.length<10&&n.push(...(await Fp.getAllFromIndex(`vibecoins`,`by-name`,t,10-n.length)).map(e=>e.cycle));for(let e=0;e<n.length;e+=1)n.indexOf(n[e],e+1)>=0&&(n.splice(e,1),--e);return n}async function Bp(e){if(e=Number(e),Fp)return(await Fp.getFromIndex(`vibecoins`,`by-cycle`,e))?.address}var Vp=300*1e3,Hp=30*1e3,Up=3333;function Wp(){Z(`meta.chainTimeDelta`,[`meta.chainTimeDelta`],async()=>{let e=await R(e=>e.getBlock({blockTag:`latest`})),t=Number(e.timestamp)-Date.now()/1e3;return t=t<60?0:Math.round(t/10)*10,[t]},X.Static),Z(`meta.shmonRate`,[`meta.shmonRate`],async()=>[await R(e=>e.readContract({address:j.shmon,abi:dd,functionName:`convertToAssets`,args:[10n**18n]}))],X.Live,Vp),Z(`game.settlementTimestamp`,[`game.settlementTimestamp`],async()=>[await R(e=>e.readContract({address:j.game,abi:B,functionName:`settlementTimestamp`,args:[]}))],X.Live,Hp),Z(`game.maxRoundDuration`,[`game.maxRoundDuration`],async()=>[await R(e=>e.readContract({address:j.game,abi:B,functionName:`maxRoundDuration`,args:[]}))],X.Live,Hp),Z(`game.state`,[`game.phase`,`game.cycle`,`game.phaseEndTime`,`game.prizePool`,`game.lastBuyer`,`game.vibecoin`,`game.isSettled`],async()=>{let e=await R(e=>e.readContract({address:j.game,abi:B,functionName:`gameState`,args:[!1]})),t=e.phase===3;return[e.phase,e.cycle,e.phaseEndTime,e.prizePool,e.lastBuyer,e.vibecoin.toLowerCase(),t]},X.Live),Z(`game.vibecoinByCycle$`,[`game.vibecoinByCycle$`],async e=>{let t=await Bp(Number(e));return t===`0x0000000000000000000000000000000000000000`?[void 0]:[t]},X.StaticWhenKnown),Z(`game.accountInfo$from$`,[`game.seriesADeposit$from$`,`game.seriesBDeposit$from$`,`game.hasClaimedSeriesA$from$`,`game.hasClaimedSeriesB$from$`],async(e,t)=>{let n=await R(n=>n.readContract({address:j.game,abi:B,functionName:`accountInfo`,args:[BigInt(e),t]}));return[n[0],n[1],n[3],n[4]]},X.Live,Up),Z(`game.seriesADeposit$`,[`game.seriesADeposit$`],async e=>{let t=BigInt(e),n=Y(`game.cycle`),r=Y(`game.phase`);return n==null||r==null?[void 0]:t==n&&r<2?[await R(e=>e.readContract({address:j.game,abi:B,functionName:`totalSeriesA`,args:[]}))]:[await R(e=>e.readContract({address:j.game,abi:B,functionName:`totalSeriesAByCycle`,args:[t]}))]},X.Live,Hp,[`game.cycle`,`game.phase`]),Z(`game.seriesBDeposit$`,[`game.seriesBDeposit$`],async e=>{let t=BigInt(e),n=Y(`game.cycle`),r=Y(`game.phase`);return n==null||r==null?[void 0]:t==n&&r<2?[await R(e=>e.readContract({address:j.game,abi:B,functionName:`totalSeriesB`,args:[]}))]:[await R(e=>e.readContract({address:j.game,abi:B,functionName:`totalSeriesBByCycle`,args:[t]}))]},X.Live,Hp,[`game.cycle`,`game.phase`]);for(let e of[`tokensSeriesAByCycle`,`tokensSeriesBByCycle`,`winnerByCycle`,`prizeByCycle`])Z(`game.`+e+`$`,[`game.`+e+`$`],async t=>{let n=BigInt(t);return[await R(t=>t.readContract({address:j.game,abi:B,functionName:e,args:[n]}))]},X.Live,Hp);Z(`game.referralEarned$`,[`game.referralEarned$`],async e=>[await R(t=>t.readContract({address:j.game,abi:B,functionName:`referralEarned`,args:[e]}))],X.Live,Hp),Z(`game.referralCodeOf$`,[`game.referralCodeOf$`],async e=>[_d(await R(t=>t.readContract({address:j.game,abi:B,functionName:`referralCodeOf`,args:[e]})))||``],X.Live,Hp),Z(`game.settlementTimestamp`,[`game.settlementTimestamp`],async()=>[await R(e=>e.readContract({address:j.game,abi:B,functionName:`settlementTimestamp`,args:[]}))],X.Live,Hp),Z(`game.consts`,[`game.const.seriesADuration`,`game.const.seriesAProtocol`,`game.const.seriesAReferral`,`game.const.seriesAPrize`,`game.const.seriesBProtocol`,`game.const.seriesBReferral`,`game.const.seriesBPrize`,`game.const.pumpProtocol`,`game.const.pumpReferral`,`game.const.pumpPrize`],async()=>{let e=[`SERIES_A_DURATION`,`SERIES_A_PROTOCOL`,`SERIES_A_REFERRAL`,`SERIES_A_PRIZE`,`SERIES_B_PROTOCOL`,`SERIES_B_REFERRAL`,`SERIES_B_PRIZE`,`PUMP_PROTOCOL`,`PUMP_REFERRAL`,`PUMP_PRIZE`],t=[];for(let n of e)try{t.push(await R(e=>e.readContract({address:j.game,abi:B,functionName:n}))),await new Promise(e=>setTimeout(e,95))}catch{t.push(void 0)}return t},X.StaticWhenKnown),Z(`game.const.minBuy`,[`game.const.minBuy`],async()=>[await R(e=>e.readContract({address:j.game,abi:B,functionName:`MIN_BUY`}))],X.StaticWhenKnown),Z(`game.const.seriesAKickoff`,[`game.const.seriesAKickoff`],async()=>[await R(e=>e.readContract({address:j.game,abi:B,functionName:`SERIES_A_KICKOFF`}))],X.StaticWhenKnown),Z(`game.const.initialTimer`,[`game.const.initialTimer`],async()=>[await R(e=>e.readContract({address:j.game,abi:B,functionName:`INITIAL_TIMER`}))],X.StaticWhenKnown),Z(`token$allowance$spender$`,[`token$allowance$spender$`],async(e,t,n)=>[await R(r=>r.readContract({address:e,abi:V,functionName:`allowance`,args:[t,n]}))],X.Live,Up),Z(`token$balance$`,[`token$balance$`],async(e,t)=>e==`native`?[await R(e=>e.getBalance({address:t}))]:[await R(n=>n.readContract({address:e,abi:V,functionName:`balanceOf`,args:[t]}))],X.Live,Up),Z(`token$earned$`,[`token$earned$`],async(e,t)=>[await R(n=>n.readContract({address:e,abi:V,functionName:`earned`,args:[t]}))],X.Live,Up),Z(`token$pendingRewards$`,[`token$pendingRewards$`],async(e,t)=>[await R(n=>n.readContract({address:e,abi:ud,functionName:`pendingRewards`,args:[t]}))],X.Live,Up),Z(`token$optedIn$`,[`token$optedIn$`],async(e,t)=>[await R(n=>n.readContract({address:e,abi:ud,functionName:`optedIn`,args:[t]}))],X.Live,Up),Z(`token$seed`,[`token$seed`,`token$palette`],async e=>{let t=await R(t=>t.readContract({address:e,abi:V,functionName:`seed`,args:[]}));return[t,pd(t)]},X.StaticWhenKnown);for(let e of[`name`,`symbol`,`K`,`P0`])Z(`token$`+e,[`token$`+e],async t=>[await R(n=>n.readContract({address:t,abi:V,functionName:e,args:[]}))],X.StaticWhenKnown);Z(`token$logoUri`,[`token$logoUri`],async e=>{let t=await R(t=>t.readContract({address:e,abi:V,functionName:`tokenURI`,args:[]}));return t.startsWith(`data:application/json`)?[JSON.parse(atob(t.split(`,`)[1])).image]:[void 0]},X.StaticWhenKnown);for(let e of[`totalSupply`,`poolBalance`,`athPrice`,`totalVolume`,`volume24h`])Z(`token$`+e,[`token$`+e],async t=>[await R(n=>n.readContract({address:t,abi:V,functionName:e,args:[]}))],X.Live,Hp);for(let e of[`unlocked`,`athPostRug`])Z(`token$`+e,[`token$`+e],async t=>{let n=await R(n=>n.readContract({address:t,abi:V,functionName:e,args:[]}));return n&&ir.remove(`token:`+t+`:`+e),[n]},X.Live,Hp);Z(`fomon.consts`,[`fomon.const.airdropReserve`,`fomon.const.totalSupply`],async()=>{let e=[`AIRDROP_RESERVE`,`TOTAL_SUPPLY`],t=[];for(let n of e)try{t.push(await R(e=>e.readContract({address:j.fomon,abi:ud,functionName:n}))),await new Promise(e=>setTimeout(e,95))}catch{t.push(void 0)}return t},X.StaticWhenKnown),Z(`fomon.minted`,[`fomon.airdropMinted`,`fomon.airdropRemaining`],async()=>{let e=await R(e=>e.readContract({address:j.fomon,abi:ud,functionName:`totalAirdropMinted`})),t=Y(`fomon.const.airdropReserve`);return[e,t==null?void 0:t-e]},X.Live,0,[`fomon.const.airdropReserve`]),Z(`fomon.mintable`,[`fomon.mintable`],async()=>[await R(e=>e.readContract({address:j.fomon,abi:ud,functionName:`remainingCeiling`}))],X.Live),Z(`fomon.mintableThisRound`,[`fomon.mintableThisRound`],async()=>{let e=Y(`game.maxRoundDuration`),t=Y(`game.settlementTimestamp`),n=Y(`game.const.initialTimer`);return!t||!e||!n?[void 0]:[await R(r=>r.readContract({address:j.fomon,abi:ud,functionName:`remainingCeilingAt`,args:[t+n+e]}))]},X.Live,100,[`game.maxRoundDuration`,`game.settlementTimestamp`,`game.const.initialTimer`])}var Gp=new Map([[`token:native:name`,`Monad`],[`token:native:symbol`,`MON`],[`token:${j.shmon.toLowerCase()}:symbol`,`shMON`],[`token:${j.fomon.toLowerCase()}:symbol`,`foMON`]]),Kp=new Map,qp=new Set,Jp=new Map,Yp=new Map,Xp=new Map,Zp=2,Qp=bd();Qn(`rugpad_storage_revision`)!==Zp&&(localStorage.clear(),xd(Qp),$n(`rugpad_storage_revision`,Zp));function $p(e){let t=[],n=``,r=0,i=e.indexOf(`:`);for(;i!=-1;)n+=e.substring(r,i)+`$`,r=i+1,i=e.indexOf(`:`,r),i==-1&&(i=e.length),t.push(e.substring(r,i)),r=i+1,i=e.indexOf(`:`,r);return n+=e.substring(r),[n,t]}function em(e,t){t=[...t].reverse();let n=e.replaceAll(`$`,()=>`:`+(t.pop()??console.warn(e,`fed too little arguments`)??``)+`:`);return n.endsWith(`:`)?n.substring(0,n.length-1):n}function Y(e,t,...n){let r=qp.has(e);if(r){let[t,r]=$p(e);tm(em(Kp.get(t),r),n)}let i=Gp.get(e);if(i!==void 0)return i;if(i=Qn(`lls:`+Zn+`:`+e),i!==void 0)return Gp.set(e,i),i;if(!r){let[r,i]=$p(e),a=Kp.get(r);if(!a){console.error(e,`has no associated task! This may result in an infinite loading circle.`);return}let o=Jp.get(a);if(!o){console.error(a,`was not defined! This may result in an infinite loading circle.`);return}qp.add(e);let s=em(a,i);for(let e of Yp.get(a)||[]){Y(em(e,i),t,...n);let a=Kp.get(r);if(!a)continue;let o=em(a,i),c=Xp.get(s);c||(c=new Set,Xp.set(s,c)),c.add(o)}let c=o.fn,l={name:s,fn:()=>c(...i),repeatMs:o.repeatMs};t?ir.prepend(l):ir.upsert(l),ir.elementRequestedTask(s,...n)}}function tm(e,t,n=new Set){if(!n.has(e)){n.add(e),ir.elementRequestedTask(e,...t);for(let r of Xp.get(e)||[])tm(r,t,n)}}var X=function(e){return e[e.Static=0]=`Static`,e[e.StaticWhenKnown=1]=`StaticWhenKnown`,e[e.Live=2]=`Live`,e}({});function Z(e,t,n,r,i=0,a=[]){Yp.set(e,a),Jp.set(e,{template:e,fn:async(...i)=>{let a=await n(...i),o=!1,s=new Map;for(let e=0;e<t.length;e+=1){let n=t[e],c=em(n,i),l=Gp.get(c),u=a[e];l!==u&&s.set(c,u),u===void 0?o=!0:(Gp.set(c,u),r<=X.StaticWhenKnown&&$n(`lls:`+Zn+`:`+c,u))}if(r==X.StaticWhenKnown&&!o){let t=em(e,i);ir.remove(t)}s.size&&window.dispatchEvent(new CustomEvent(`lls-updated`,{detail:s}))},repeatMs:r==X.Static?void 0:i});for(let n of t)Kp.set(n,e)}function nm(){Wp()}var rm=25,im=5,am=1,om=60,sm=90,cm=class extends HTMLElement{constructor(...e){super(...e),this._phosphor=null,this._rafId=0,this._marqueeX=0,this._marqueeText=`VIBE CHECKING...`,this._marqueeColor=`rgba(255,230,0,0.9)`,this._candles=[],this._loadingVcAddr=``,this._currentVcAddr=``,this._K=0n,this._P0=0n,this._onLiveUpdate=()=>{let e=Y(`game.phase`,!1,this),t=Y(`game.cycle`,!1,this),n=Y(`game.phaseEndTime`,!1,this),r=Y(`meta.chainTimeDelta`,!1,this)??0,i=Number(Y(`game.const.seriesADuration`,!1,this));if(e===void 0||t===void 0||n==null||isNaN(i)){this._marqueeText=`VIBE CHECKING...`,this._marqueeColor=`rgba(255,230,0,0.9)`;return}let a=Date.now()/1e3+r,o=e===0&&n>0n?Number(n)-a:1/0,s=e===0&&t>1n&&(n===0n||o>i/2),c=s?t-1n:t,l=s?3:e,u=s||l===2||l===3?Y(`game.vibecoinByCycle:${c}`,!1,this):l===1?Y(`game.vibecoin`,!1,this):void 0;if(u===void 0){this._marqueeText=`VIBE CHECKING...`,this._marqueeColor=`rgba(255,230,0,0.9)`;return}let d=u.toLowerCase();if(l===2&&a<Number(n)&&d!==`0x0000000000000000000000000000000000000000`){let e=Y(`token:${d}:name`,!1,this),t=Y(`token:${d}:symbol`,!1,this);e===void 0||t===void 0?(this._marqueeText=`VIBE CHECKING...`,this._marqueeColor=`rgba(255,230,0,0.9)`):(this._marqueeText=`PUMP ${e}! — $${t} TO THE MOON`,this._marqueeColor=`rgba(0,229,255,0.9)`)}else l===3||l===2&&a>=Number(n)?(this._marqueeText=`GET RUGGED`,this._marqueeColor=`rgba(255,45,107,0.9)`):(this._marqueeText=`GENERATING VIBECOIN`,this._marqueeColor=`rgba(255,230,0,0.9)`);let f=d===`0x0000000000000000000000000000000000000000`?void 0:Y(`token:${d}:K`,!1,this),p=d===`0x0000000000000000000000000000000000000000`?void 0:Y(`token:${d}:P0`,!1,this);if(u!==this._currentVcAddr&&d!==`0x0000000000000000000000000000000000000000`&&p!=null&&f!=null){this._K=f,this._P0=p,this._currentVcAddr=u,this._candles=[];let e=this._buf.width||Math.ceil(window.innerWidth/rm);this._startCandleLoad(u,this._K,this._P0,Math.ceil(e/im)+2)}let m=d===`0x0000000000000000000000000000000000000000`?void 0:Y(`token:${d}:totalSupply`,!1,this);if(m!==void 0&&this._candles[0]&&p!=null&&f!=null){let e=Number(this._P0+this._K*m/10n**18n),t=this._candles[0];this._candles[0]={open:t.open,close:e,high:Math.max(t.high,e),low:Math.min(t.low,e)}}}}connectedCallback(){this.style.cssText=`position:fixed;inset:0;z-index:0;pointer-events:none;overflow:hidden`,this._canvas=document.createElement(`canvas`),this._canvas.style.cssText=`display:block;width:100%;height:100%`,this.appendChild(this._canvas),this._ctx=this._canvas.getContext(`2d`),this._buf=document.createElement(`canvas`),this._bCtx=this._buf.getContext(`2d`),this._bloom=document.createElement(`canvas`),this._blCtx=this._bloom.getContext(`2d`),this._ro=new ResizeObserver(()=>this._onResize()),this._ro.observe(this),window.addEventListener(`lls-updated`,this._onLiveUpdate),this._onLiveUpdate(),this._startAnimation()}disconnectedCallback(){cancelAnimationFrame(this._rafId),this._ro.disconnect(),window.removeEventListener(`lls-updated`,this._onLiveUpdate)}_onResize(){let e=Math.round(this.offsetWidth),t=Math.round(this.offsetHeight);if(!e||!t)return;this._canvas.width=e,this._canvas.height=t,this._bloom.width=e,this._bloom.height=t;let n=Math.ceil(e/rm),r=Math.ceil(t/rm);this._buf.width=n,this._buf.height=r;let i=document.createElement(`canvas`);i.width=rm,i.height=rm;let a=i.getContext(`2d`),o=rm-4,s=Math.floor(o/3);a.fillStyle=`#000`,a.fillRect(0,0,rm,rm),a.fillStyle=`rgb(255,0,0)`,a.fillRect(2,2,s,o),a.fillStyle=`rgb(0,255,0)`,a.fillRect(2+s,2,s,o),a.fillStyle=`rgb(0,0,255)`,a.fillRect(2+s*2,2,s,o),this._phosphor=this._ctx.createPattern(i,`repeat`);let c=Math.ceil(n/im)+2;c>this._candles.length&&this._currentVcAddr&&this._startCandleLoad(this._currentVcAddr,this._K,this._P0,c)}_startCandleLoad(e,t,n,r){this._loadingVcAddr=e,setTimeout(()=>{this._loadingVcAddr===e&&this._loadCandles(e,t,n,r)},3e3)}async _loadCandles(e,t,n,r){let i=od(),a=10n**18n,o,s;try{let t=await nr(()=>i.getBlock(),!1,`candle:${e}:ref`);o=t.number,s=Number(t.timestamp)}catch{return}if(this._loadingVcAddr!==e)return;let c=150n;try{let t=await nr(()=>i.getBlock({blockNumber:o-50n}),!1,`candle:${e}:probe`),n=s-Number(t.timestamp);n>0&&(c=BigInt(Math.round(50*om/n)))}catch{}if(this._loadingVcAddr!==e)return;let l=[];for(let s=0;s<=r;s++){if(this._loadingVcAddr!==e)return;let r=o-BigInt(s)*c;if(r<0n){l.push(null);continue}try{let o=await nr(()=>i.readContract({address:e,abi:V,functionName:`totalSupply`,blockNumber:r}),!1,`candle:${e}:s${s}`);l.push(Number(n+t*o/a))}catch{l.push(null)}}if(this._loadingVcAddr===e)for(let e=0;e<r;e++){let t=l[e],n=l[e+1];t!==null&&n!==null&&(this._candles[e]={close:t,open:n,high:Math.max(t,n),low:Math.min(t,n)})}}_startAnimation(){let e=performance.now(),t=n=>{let r=(n-e)/1e3;e=n,this._marqueeX-=sm*r,this._draw(),this._rafId=requestAnimationFrame(t)};this._rafId=requestAnimationFrame(t)}_draw(){let e=this._canvas.width,t=this._canvas.height,n=this._buf.width,r=this._buf.height;if(!e||!t||!n||!r)return;let i=this._bCtx;i.fillStyle=`rgb(6,6,8)`,i.fillRect(0,0,n,r),this._drawCandlesBuf(i,n,r),this._drawMarqueeBuf(i,n,r);let a=n*rm,o=r*rm,s=this._ctx;s.imageSmoothingEnabled=!1,s.drawImage(this._buf,0,0,a,o),this._phosphor&&(s.globalCompositeOperation=`multiply`,s.fillStyle=this._phosphor,s.fillRect(0,0,a,o),s.globalCompositeOperation=`source-over`);let c=this._blCtx;c.clearRect(0,0,e,t),c.filter=`blur(5px)`,c.drawImage(this._canvas,0,0),c.filter=`none`,s.globalCompositeOperation=`screen`,s.globalAlpha=.35,s.drawImage(this._bloom,0,0),s.globalAlpha=1,s.globalCompositeOperation=`source-over`}_drawCandlesBuf(e,t,n){let r=this._candles.filter(e=>e!==null);if(r.length<2)return;let i=1/0,a=-1/0;for(let e of r)e.low<i&&(i=e.low),e.high>a&&(a=e.high);if(a===i)return;let o=Math.round(n*.1),s=Math.round(n*.1),c=n-o-s,l=e=>n-s-Math.round((e-i)/(a-i)*c);for(let n=0;n<r.length;n++){let i=r[n],a=t-(n+1)*im;if(a+im<0)break;e.fillStyle=i.close>=i.open?`rgba(0,229,255,0.2)`:`rgba(255,45,107,0.2)`;let o=a+Math.floor((im-am)/2),s=l(i.high),c=l(i.low);e.fillRect(o,s,am,Math.max(1,c-s));let u=l(Math.max(i.open,i.close)),d=l(Math.min(i.open,i.close));e.fillRect(a,u,im,Math.max(1,d-u))}}_drawMarqueeBuf(e,t,n){let r=Math.round(n*.8);e.save(),e.font=`${r}px "Bebas Neue", sans-serif`,e.fillStyle=this._marqueeColor,e.textBaseline=`middle`;let i=this._marqueeText+` — `,a=e.measureText(i).width;if(a<1){e.restore();return}let o=(this._marqueeX/rm%a-a)%a;for(;o<t+a;)e.fillText(i,o,n/2),o+=a;e.restore()}};customElements.get(`app-background`)||customElements.define(`app-background`,cm);var lm=10n**18n,Q=class extends up{constructor(...e){super(...e),this.liveKeys=new Set,this._onLiveUpdate=e=>{for(let t of this.liveKeys)if(e.detail.has(t)){this.requestUpdate();break}},this._onDenomChanged=()=>this.requestUpdate()}static{this.styles=of`
  ...
  `]}connectedCallback(){super.connectedCallback(),Ju.addEventListener(`wallet-changed`,this._onWalletChanged),this._timerInterval=setInterval(()=>this.requestUpdate(),1e3)}disconnectedCallback(){super.disconnectedCallback(),Ju.removeEventListener(`wallet-changed`,this._onWalletChanged),this._timerInterval&&=(clearInterval(this._timerInterval),null)}async _claimA(){let e=Y(`game.cycle`),t=z();if(!(!t||!L||e===void 0)){this.claimPendingA=!0;try{J(await t.writeContract({address:j.game,abi:B,functionName:`claimSeriesATokens`,args:[e],account:L.address,chain:t.chain}),`Claimed Insider Vibecoins`)}catch(e){console.error(`Claim A error:`,e)}finally{this.claimPendingA=!1}}}async _claimB(){let e=Y(`game.cycle`),t=z();if(!(!t||!L||e===void 0)){this.claimPendingB=!0;try{J(await t.writeContract({address:j.game,abi:B,functionName:`claimSeriesBTokens`,args:[e],account:L.address,chain:t.chain}),`Claimed "Insider" Vibecoins`)}catch(e){console.error(`Claim B error:`,e)}finally{this.claimPendingB=!1}}}_phaseStatus(e,t,n,r,i){if(e<t)return`ENDED`;if(n===0n&&t===0)return e===0?`DEPOSIT TO KICK OFF (${i===void 0?`…`:Sp(i,0)} needed)`:`PENDING`;if(e<t)return`ENDED`;let a=Math.max(Number(n)-(Date.now()/1e3+r),0),o=Math.floor(a/3600),s=Math.floor(a%3600/60),c=Math.floor(a%60);return`${e>t?`OPENS`:`ENDS`} IN ${o}h ${s}m ${c}s`}render(){let e=L?.address.toLowerCase()??``,t=this.liveValue(`game.cycle`),n=this.liveValue(`game.phase`),r=this.liveValue(`game.phaseEndTime`),i=this.liveValue(`meta.chainTimeDelta`)??0;if(t===void 0||n===void 0)return H`<div class="cards">${this.spin}</div>`;let a=n===0,o=n===1,s=n===2||n===3,c=s?(this.liveValue(`game.vibecoinByCycle:${t}`)??``).toLowerCase():``,l=e?this.liveValue(`game.seriesADeposit:${t}:from:${e}`):void 0,u=e?this.liveValue(`game.seriesBDeposit:${t}:from:${e}`):void 0,d=e?l===void 0?void 0:l>0n:!1,f=e?u===void 0?void 0:u>0n:!1,p=e?this.liveValue(`game.hasClaimedSeriesA:${t}:from:${e}`):!1,m=e?this.liveValue(`game.hasClaimedSeriesB:${t}:from:${e}`):!1,h=this.liveValue(`game.const.seriesAKickoff`),g=r===void 0?void 0:this._phaseStatus(0,n,r,i,h),_=r===void 0?void 0:this._phaseStatus(1,n,r,i);return H`
      <div class="cards">
        <!-- Series A -->
  ...
  `]}connectedCallback(){super.connectedCallback(),this._genInterval=setInterval(()=>this._tickGen(),150),this._tickInterval=setInterval(()=>this.requestUpdate(),1e3),this._taglineInterval=setInterval(()=>{let e=this._taglineIdx;for(;e===this._taglineIdx;)e=Math.floor(Math.random()*Om.length);this._taglineIdx=e},5e3)}disconnectedCallback(){super.disconnectedCallback(),this._genInterval&&=(clearInterval(this._genInterval),null),this._tickInterval&&=(clearInterval(this._tickInterval),null),this._taglineInterval&&=(clearInterval(this._taglineInterval),null)}async _settle(){let e=z();if(!(!e||!L)){this.settlePending=!0;try{J(await e.writeContract({address:j.game,abi:B,functionName:`settleSeriesB`,account:L.address,chain:e.chain}),`Vibecoin generated — insider rounds settled`)}catch(e){Np(e)}finally{this.settlePending=!1}}}_tickGen(){this._scrambledTicker=Em(),this._tickCount++;let e=this._genStats;if(e.tokensConsumed+=Math.floor(Math.random()*14)+4,e.exitLiquidity+=Math.floor(Math.random()*8)+2,e.hopium+=+(Math.random()<.3),e.bagHolders+=Math.floor(Math.random()*6)+1,e.rugThreads=Math.min(99.7,e.rugThreads+Math.random()*.02),Math.random()<.02&&(e.grayAreas+=1),Math.random()<.01&&(e.marketMakers+=1),this._tickCount%20==0){let e=this._headingIdx;for(;e===this._headingIdx;)e=Math.floor(Math.random()*Dm.length);this._headingIdx=e}if(this._tickCount%27==0){let e=this._statIdx;for(;e===this._statIdx;)e=Math.floor(Math.random()*km.length);this._statIdx=e,(e===9||e===10)&&(this._genStats={...this._genStats,grayAreas:Math.floor(Math.random()*3)+1,marketMakers:Math.floor(Math.random()*2)+1})}}render(){let e=j,t=this.liveValue(`game.phase`),n=this.liveValue(`game.cycle`),r=this.liveValue(`game.phaseEndTime`),i=this.liveValue(`meta.chainTimeDelta`)??0,a=this.liveValue(`game.const.seriesADuration`);if(t===void 0||n===void 0||r===void 0)return H`
        ...
        >
          ...
          `:v?H`
            <div class="vc-pending">
              ...
              ${km[this._statIdx].label}: <span class="count">${km[this._statIdx].value(this._genStats)}</span><br>
              <br>
          ...
          `:H`
            ...
            ${g?H`
              ...
              <div class="hero-tagline">${Om[this._taglineIdx]}</div>
            `:``}
          `}
        </div>
    ...
    `}};q([K()],jm.prototype,`_scrambledTicker`,void 0),q([K()],jm.prototype,`_headingIdx`,void 0),q([K()],jm.prototype,`_statIdx`,void 0),q([K()],jm.prototype,`_genStats`,void 0),q([K()],jm.prototype,`settlePending`,void 0),q([K()],jm.prototype,`_taglineIdx`,void 0),jm=q([W(`pump-tab`)],jm);var Mm=class extends Q{constructor(...e){super(...e),this.cycle=0,this.claimAPending=!1,this.claimBPending=!1,this.claimDivPending=!1,this.optInPending=!1,this._onWalletChanged=()=>{this.requestUpdate()}}static{this.styles=[Q.styles,of`
    :host { display: block; }
    ...
    .btn:disabled { opacity: 0.25; cursor: not-allowed; }
  `]}connectedCallback(){super.connectedCallback(),Ju.addEventListener(`wallet-changed`,this._onWalletChanged)}disconnectedCallback(){super.disconnectedCallback(),Ju.removeEventListener(`wallet-changed`,this._onWalletChanged)}async _claimDividends(){let e=z();if(!e||!L)return;let t=Y(`game.vibecoinByCycle:${this.cycle}`);if(t){this.claimDivPending=!0;try{J(await e.writeContract({address:t,abi:V,functionName:`claimDividends`,args:[L.address],account:L.address,chain:e.chain}),`Claim Vibes`)}catch(e){Np(e)}finally{this.claimDivPending=!1}}}async _claimA(){let e=z();if(!(!e||!L)){this.claimAPending=!0;try{J(await e.writeContract({address:j.game,abi:B,functionName:`claimSeriesATokens`,args:[BigInt(this.cycle)],account:L.address,chain:e.chain}),`Claimed Insider Vibecoins`)}catch(e){Np(e)}finally{this.claimAPending=!1}}}async _claimB(){let e=z();if(!(!e||!L)){this.claimBPending=!0;try{J(await e.writeContract({address:j.game,abi:B,functionName:`claimSeriesBTokens`,args:[BigInt(this.cycle)],account:L.address,chain:e.chain}),`Claimed "Insider" Vibecoins`)}catch(e){Np(e)}finally{this.claimBPending=!1}}}async _optIn(){let e=z();if(!e||!L)return;let t=Y(`game.vibecoinByCycle:${this.cycle}`);if(t){this.optInPending=!0;try{J(await e.writeContract({address:t,abi:V,functionName:`optIn`,account:L.address,chain:e.chain}),`Vibes desired`)}catch(e){Np(e)}finally{this.optInPending=!1}}}render(){if(this.cycle<=0)return H`
          ...
          <div class="stats">
            ...
            ${te?H`
              ...
              <span class="stat-val">
                ...
                ${E?H`
                  <a style="color:#ff2d6b;text-decoration:none" href="${E}/address/${c}" target="_blank">${Ep(c)}</a>
    ...
    `}};q([G({type:Number})],Mm.prototype,`cycle`,void 0),q([K()],Mm.prototype,`claimAPending`,void 0),q([K()],Mm.prototype,`claimBPending`,void 0),q([K()],Mm.prototype,`claimDivPending`,void 0),q([K()],Mm.prototype,`optInPending`,void 0),Mm=q([W(`vibecoin-card`)],Mm);var Nm=20,Pm=class extends Q{constructor(...e){super(...e),this.search=``,this.searchResults=null,this.visibleCount=Nm,this.observer=null,this.sentinelEl=null,this._searchDebounce=null,this._onHashChange=()=>this._applyHash()}static{this.styles=[Q.styles,of`
    :host { display: block; }
  ...
  `]}connectedCallback(){super.connectedCallback(),window.addEventListener(`hashchange`,this._onHashChange),this._applyHash()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`hashchange`,this._onHashChange),this.observer?.disconnect(),this._searchDebounce&&clearTimeout(this._searchDebounce)}_applyHash(){let e=window.location.hash.split(`?`)[0].match(/^#vibecoins\/(0x[0-9a-fA-F]{40})$/);e&&this._setSearch(e[1])}_setSearch(e){if(this.search=e,this.visibleCount=Nm,this._searchDebounce&&clearTimeout(this._searchDebounce),!e.trim()){this.searchResults=null;return}this.searchResults=null,this._searchDebounce=setTimeout(()=>void this._doSearch(e.trim().toLowerCase()),200)}async _doSearch(e){let t=await zp(e);this.search.trim().toLowerCase()===e&&(this.searchResults=t??[])}updated(){let e=this.renderRoot?.querySelector(`.sentinel`);e&&e!==this.sentinelEl&&(this.observer?.disconnect(),this.sentinelEl=e,this.observer=new IntersectionObserver(e=>{e[0].isIntersecting&&(this.visibleCount+=Nm)},{rootMargin:`200px`}),this.observer.observe(e))}render(){let e=this.liveValue(`game.cycle`),t=this.liveValue(`game.phase`),n=this.search.trim()!==``,r,i;if(n)r=this.searchResults??[],i=this.searchResults===null;else if(e===void 0||t===void 0)r=[],i=!0;else{let n=t>=2?Number(e):Number(e)-1;r=[];for(let e=n;e>=1;e--)r.push(e);i=!1}let a=r.slice(0,this.visibleCount);return H`
      <div class="container">
    ...
    `}};q([K()],Pm.prototype,`search`,void 0),q([K()],Pm.prototype,`searchResults`,void 0),q([K()],Pm.prototype,`visibleCount`,void 0),Pm=q([W(`vibecoins-tab`)],Pm);function Fm(e){if(e<0n)throw Error(`sqrt of negative`);if(e===0n)return 0n;let t=e,n=(t+1n)/2n;for(;n<t;)t=n,n=(t+e/t)/2n;return t}function Im(e,t,n,r){let i=10n**18n,a=n*t/i+r*t*t/(2n*i*i)+e,o=Fm(n*n+2n*r*a);if(r===0n)return 0n;let s=(o-n)*i/r;return s>t?s-t:0n}var Lm=class extends Q{constructor(...e){super(...e),this.visible=!1,this.target=`publicBuy`,this.amountStr=``,this.useShMon=!1,this.pending=!1,this.approvePending=!1,this.error=``,this._sellShMonPreview=0n,this._buyPreview=null,this._tokenBalance=0n,this._refCode=null}static{this.styles=[Q.styles,of`
    :host { display: block; }
  ...
  `]}open(e){if(this.target=e.target,this.vibecoinAddress=e.vibecoinAddress,this._tokenBalance=e.tokenBalance??0n,this._refCode=bd(),this.pending=!1,this.approvePending=!1,this.error=``,this._sellShMonPreview=0n,this._buyPreview=null,e.target!==`vibecoinSell`){let t=localStorage.getItem(this._storageKey(e.target));if(t){let{amount:e,useShMon:n}=JSON.parse(t);this.amountStr=e??``,this.useShMon=n??!1}else this.amountStr=``,this.useShMon=!1}else this.amountStr=``,this.useShMon=!1;this.visible=!0}_storageKey(e){return`buy-dialog:lastAmount:${e}`}async _updateSellPreview(){let e=this._amountWei;if(e===0n||!this.vibecoinAddress){this._sellShMonPreview=0n;return}try{this._sellShMonPreview=await od().readContract({address:this.vibecoinAddress,abi:V,functionName:`shMonForTokens`,args:[e]})}catch{this._sellShMonPreview=0n}}_close(){this.visible=!1}get _amountWei(){let[e,t,n]=this.amountStr.match(/^([0-9]+)\.?([0-9]+)?$/)??[];return t?(n=n?n.slice(0,18).padEnd(18,`0`):`0`,BigInt(t)*10n**18n+BigInt(n)):0n}_effectiveVcAddrLow(){return this.vibecoinAddress?this.vibecoinAddress.toLowerCase():(this.liveValue(`game.vibecoin`)??``).toLowerCase()}_getTitle(){let e=this._effectiveVcAddrLow(),t=e?this.liveValue(`token:${e}:name`):void 0;switch(this.target){case`seriesA`:return`INSIDER ROUND`;case`seriesB`:return`"INSIDER" ROUND`;case`publicBuy`:return t?`PUMP ${t.toUpperCase()}`:`PUMP`;case`vibecoin`:return t?`BUY ${t.toUpperCase()}`:`BUY`;case`vibecoinSell`:return t?`SELL ${t.toUpperCase()}`:`SELL`}}_getFeeBreakdown(){if(this.target===`vibecoin`)return[[`Dividend pool`,1000n],[`To buyer`,9000n]];switch(this.target){case`seriesA`:{let e=this.liveValue(`game.const.seriesAProtocol`)??400n,t=this.liveValue(`game.const.seriesAReferral`)??600n,n=this.liveValue(`game.const.seriesAPrize`)??2000n;return[[`Protocol`,e],[`Referral`,t],[`Rugpull Fund`,n],[`Vibecoins minted`,10000n-e-t-n]]}case`seriesB`:{let e=this.liveValue(`game.const.seriesBProtocol`)??400n,t=this.liveValue(`game.const.seriesBReferral`)??600n,n=this.liveValue(`game.const.seriesBPrize`)??1000n;return[[`Protocol`,e],[`Referral`,t],[`Rugpull Fund`,n],[`Vibecoins minted`,10000n-e-t-n]]}default:{let e=this.liveValue(`game.const.pumpProtocol`)??400n,t=this.liveValue(`game.const.pumpReferral`)??600n,n=this.liveValue(`game.const.pumpPrize`)??2400n;return[[`Protocol`,e],[`Referral`,t],[`Rugpull Fund`,n],[`Vibecoin mint`,10000n-e-t-n]]}}}_computeTokenPreview(){let e=this._amountWei;if(e===0n)return 0n;let t=vp();if(!this.useShMon&&t===0n)return;let n=this.useShMon?e:e*10n**18n/t;if(this.target===`publicBuy`)return this._buyPreview?.tokensToUser;if(this.target===`vibecoin`){let e=this.vibecoinAddress?.toLowerCase();if(!e)return;let t=this.liveValue(`token:${e}:totalSupply`),r=this.liveValue(`token:${e}:P0`),i=this.liveValue(`token:${e}:K`);return t===void 0||r===void 0||i===void 0?void 0:Im(n,t,r,i)}return 0n}async _updateBuyPreview(){if(this.target!==`publicBuy`)return;let e=this._amountWei;if(e===0n){this._buyPreview=null;return}let t=vp();if(!this.useShMon&&t===0n)return;let n=this.useShMon?e:e*10n**18n/t;try{let e=await od().readContract({address:j.game,abi:B,functionName:`previewBuy`,args:[n]});this._buyPreview={tokensToUser:e.tokensToUser,timerExtensionMs:e.timerExtensionMs}}catch{}}_formatTimerExtension(){let e=this._buyPreview?.timerExtensionMs;if(e===void 0)return`-`;if(e===0n)return`0s`;let t=Number(e);if(t<1e3)return`+0.${String(t).padStart(3,`0`)}s`;let n=Math.floor(t/1e3);if(n<60)return`+${n}.${String(t%1e3).padStart(3,`0`)}s`;let r=Math.floor(n/60);if(r<60)return`+${r}m ${n%60}s`;let i=Math.floor(n/3600);return i<36?`+${i}h ${r%60}m`:`+${Math.floor(i/24)}d ${i%24}h`}async _approve(){let e=j,t=z();if(!(!t||!L)&&this._amountWei!==0n){this.approvePending=!0,this.error=``;try{let n=this.target===`vibecoin`?this.vibecoinAddress:e.game;J(await t.writeContract({address:e.shmon,abi:dd,functionName:`approve`,args:[n,2n**256n-1n],account:L.address,chain:t.chain}),`Approved shMON Spending`)}catch(e){Np(e)}finally{this.approvePending=!1}}}async _buy(){let e=j,t=z();if(!t||!L)return;let n=this._amountWei;if(n!==0n){if(this.target===`seriesA`||this.target===`seriesB`){let e=this.target===`seriesA`?0:1,t=Y(`game.phase`);if(t===void 0||t!==e){this.error=`${this.target===`seriesA`?`Insider`:`"Insider"`} round has already ended.`;return}let n=Y(`game.phaseEndTime`)??0n,r=Y(`meta.chainTimeDelta`)??0;if(n>0n&&Date.now()/1e3+r>=Number(n)){this.error=`${this.target===`seriesA`?`Insider`:`"Insider"`} round has already ended.`;return}}this.pending=!0,this.error=``;try{let r=wd(bd()??``),i;i=this.target===`vibecoinSell`?await t.writeContract({address:this.vibecoinAddress,abi:V,functionName:`sell`,args:[n,L.address],account:L.address,chain:t.chain}):this.useShMon?this.target===`seriesA`?await t.writeContract({address:e.game,abi:B,functionName:`depositSeriesAWithShMon`,args:[r,n],account:L.address,chain:t.chain}):this.target===`seriesB`?await t.writeContract({address:e.game,abi:B,functionName:`depositSeriesBWithShMon`,args:[r,n],account:L.address,chain:t.chain}):this.target===`publicBuy`?await t.writeContract({address:e.game,abi:B,functionName:`buyWithShMon`,args:[r,n],account:L.address,chain:t.chain}):await t.writeContract({address:this.vibecoinAddress,abi:V,functionName:`buyWithShMon`,args:[L.address,n,!0],account:L.address,chain:t.chain}):this.target===`seriesA`?await t.writeContract({address:e.game,abi:B,functionName:`depositSeriesA`,args:[r],value:n,account:L.address,chain:t.chain}):this.target===`seriesB`?await t.writeContract({address:e.game,abi:B,functionName:`depositSeriesB`,args:[r],value:n,account:L.address,chain:t.chain}):this.target===`publicBuy`?await t.writeContract({address:e.game,abi:B,functionName:`buy`,args:[r],value:n,account:L.address,chain:t.chain}):await t.writeContract({address:this.vibecoinAddress,abi:V,functionName:`buy`,args:[L.address,!0],value:n,account:L.address,chain:t.chain}),this.target!==`vibecoinSell`&&localStorage.setItem(this._storageKey(this.target),JSON.stringify({amount:this.amountStr,useShMon:this.useShMon})),this._close(),J(i,this._actionLabel())}catch(e){Np(e)}finally{this.pending=!1}}}_actionLabel(){let e=this._effectiveVcAddrLowCached(),t=e?Y(`token:${e}:symbol`)??`token`:`token`,n=e?Y(`token:${e}:name`)??``:``,r=this.useShMon?bp(this._amountWei):xp(this._amountWei);switch(this.target){case`seriesA`:return`${r} insider deposit`;case`seriesB`:return`${r} "insider" deposit`;case`publicBuy`:return`Spend ${r} pumping ${n}`;case`vibecoin`:return`Spend ${r} on ${t}`;case`vibecoinSell`:return`Sell ${wp(this._amountWei,t)} for shMON`}}_effectiveVcAddrLowCached(){return this.vibecoinAddress?this.vibecoinAddress.toLowerCase():(Y(`game.vibecoin`)??``).toLowerCase()}_renderMinBuyWarning(){if(this.target!==`publicBuy`&&this.target!==`seriesA`&&this.target!==`seriesB`||this._amountWei===0n)return H``;let e=this.liveValue(`game.const.minBuy`);if(e===void 0)return H``;let t=vp();if((this.useShMon||t===0n?this._amountWei:this._amountWei*10n**18n/t)>=e)return H``;let n;if(this.useShMon)n=bp(e);else if(t===0n)n=bp(e)+` shMON equivalent`;else{let r=(e*t/10n**18n+10n**17n-1n)/10n**17n;n=`${(Number(r)/10).toFixed(1)} MON`}return H`<div class="min-buy-warning">⚠ Minimum buy: ${n}</div>`}_renderPreview(){let e=this._amountWei,t=this._effectiveVcAddrLow(),n=t?this.liveValue(`token:${t}:symbol`)??`???`:`???`;if(this.target===`vibecoinSell`)return H`
        ...
        <div class="modal">
          ...
          <div class="field">
            <label style="display:flex;justify-content:space-between">
              ...
              ${e&&o>0n?H`<span style="color:#d8d8e8">BAL: ${wp(o,f)}</span>`:``}
            </label>
    ...
    `}};q([K()],Lm.prototype,`visible`,void 0),q([K()],Lm.prototype,`target`,void 0),q([K()],Lm.prototype,`vibecoinAddress`,void 0),q([K()],Lm.prototype,`amountStr`,void 0),q([K()],Lm.prototype,`useShMon`,void 0),q([K()],Lm.prototype,`pending`,void 0),q([K()],Lm.prototype,`approvePending`,void 0),q([K()],Lm.prototype,`error`,void 0),q([K()],Lm.prototype,`_sellShMonPreview`,void 0),q([K()],Lm.prototype,`_buyPreview`,void 0),q([K()],Lm.prototype,`_tokenBalance`,void 0),Lm=q([W(`buy-dialog`)],Lm);var Rm=`disclaimer-accepted-v1`,zm=class extends up{constructor(...e){super(...e),this.open=!localStorage.getItem(Rm)}_accept(){localStorage.setItem(Rm,`1`),this.open=!1}static{this.styles=of`
    .overlay {
  ...
  `}connectedCallback(){super.connectedCallback(),this._handleHash(),window.addEventListener(`hashchange`,this._handleHash),Ju.addEventListener(`wallet-changed`,this._onWalletChanged),window.addEventListener(`open-buy-dialog`,this._onOpenBuyDialog)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`hashchange`,this._handleHash),Ju.removeEventListener(`wallet-changed`,this._onWalletChanged),window.removeEventListener(`open-buy-dialog`,this._onOpenBuyDialog)}render(){return H`
    ...
    `}};q([K()],Bm.prototype,`tab`,void 0),Bm=q([W(`app-root`)],Bm);function Vm(e,t,n,r=new Set){let i=e+t;switch(typeof n){case`object`:if(n===null)return i+`null
`;if(r.has(n))return``;r.add(n),i+=`
`;for(let t of Object.keys(n))i+=Vm(e+`  `,JSON.stringify(t)+`: `,n[t],r);return i;case`bigint`:case`symbol`:case`function`:case`number`:case`undefined`:return i+n+`
`;default:return i+JSON.stringify(n)+`
`}}function Hm(e){let t=e instanceof Error?e.name+`: `+e.message:`Unknown error type (?!)`,n=e instanceof Error?e.stack??e.message:Vm(``,``,e);window.dispatchEvent(new CustomEvent(`app-error-show`,{detail:{short:t,full:n,name:`UNCAUGHT ERROR`}}))}window.addEventListener(`error`,e=>Hm(e.error??e.message)),window.addEventListener(`unhandledrejection`,e=>Hm(e.reason)),nm();var Um=document.getElementById(`loading-spinner`);Um&&Um.remove(),Y(`meta.shmonRate`,!0,document.documentElement);var Wm=document.body,Gm=document.createElement(`app-background`);Wm.insertBefore(Gm,Wm.firstChild);var Km=document.createElement(`div`);Km.id=`app`;var qm=document.createElement(`app-root`);Km.appendChild(qm),Wm.appendChild(Km);